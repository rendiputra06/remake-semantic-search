...
document.addEventListener("DOMContentLoaded", function () {
    ...
    function renderResults(data) {
        ...
        html += '<thead class="table-dark"><tr><th>Metode</th><th>Threshold</th><th>Prec.</th><th>Recall</th><th>F1</th><th>Acc.</th><th>TP</th><th>FP</th><th>FN</th><th class="text-center">Aksi</th></tr></thead><tbody>';
        ...
        results.forEach((r) => {
            if (r.error) {
                ...
                html += `<td class="text-center"><button class="btn btn-xs btn-primary btn-show-detail" data-method="${r.method}"><i class="fas fa-eye me-1"></i>Detail</button></td>`;
                html += "</tr>";
            }
        });
