...
class Word2VecModel:
    ...
    """
    def __init__(self, model_path: str = '../models/idwiki_word2vec/idwiki_word2vec_200_new_lower.model'):
    ...
    def load_verse_vectors(self, input_path: str = '../database/vectors/word2vec_verses.pkl') -> None:
        """
