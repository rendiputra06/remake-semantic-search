...
class FastTextModel:
    ...
    """
    def __init__(self, model_path: str = '../models/fasttext/fasttext_model.model'):
    ...
    def load_verse_vectors(self, input_path: str = '../database/vectors/fasttext_verses.pkl') -> None:
        """
